...
def test_consume_messages_success(mock_consumer, mock_describe_kafka_topic):
    ...
    mock_describe_kafka_topic.return_value = json.dumps({
        'partitions': 3
    })
...
@patch('chaoskafka.actions.describe_kafka_topic')
@patch('chaoskafka.actions.Consumer')
def test_consume_messages_partition_not_exist(mock_consumer,
                                              mock_describe_kafka_topic):
    mock_consumer_instance = MagicMock()
    mock_consumer.return_value = mock_consumer_instance
    ...
    expected_error_message = (
        "Partition 3 does not exist in topic test_topic"
    )
...
def test___consume_messages_success(mock_consumer, mock_describe_kafka_topic):
    ...
    mock_consumer_instance.poll.side_effect = [mock_poll(1.0), mock_poll(1.0), None]
...
@patch('chaoskafka.actions.describe_kafka_topic')
@patch('chaoskafka.actions.Consumer')
def test_consume_messages_none_message(mock_consumer,
                                       mock_describe_kafka_topic):
    mock_consumer_instance = MagicMock()
    mock_consumer.return_value = mock_consumer_instance
...
@patch('chaoskafka.actions.describe_kafka_topic')
@patch('chaoskafka.actions.Consumer')
def test_consume_messages_error_message(mock_consumer, mock_describe_kafka_topic):
    mock_consumer_instance = MagicMock()
    mock_consumer.return_value = mock_consumer_instance
